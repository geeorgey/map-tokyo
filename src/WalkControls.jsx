...
export default function WalkControls({ controller, onHome, onSpots, onShare, onExit }) {
  return <section className="walk-panel glass" aria-label="自由散策の操作">
    ...
    <button className="walk-share" onClick={onShare} aria-haspopup="dialog">景色のリンク ↗</button>
